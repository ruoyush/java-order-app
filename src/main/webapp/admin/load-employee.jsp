            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Update Employees
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form id="add" class="form-horizontal" name="add" action="employee" method="GET">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input id="username" name="username" placeholder="your name here" class="form-control input-md" required="" type="text" value="${the_emp.name}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input id="password" name="password" placeholder="password here" class="form-control input-md" required="" type="password" value="${the_emp.pass}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="email" name="email" placeholder="E-mail" class="form-control input-md" required="" type="email" value="${the_emp.email}">
