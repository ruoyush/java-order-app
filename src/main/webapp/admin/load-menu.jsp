            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form id="add" class="form-horizontal" name="add" action="menu" method="GET">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input type="hidden" name="empid" value="${the_menu.id}" />
                                        
                                        <input id="entree" name="entree" placeholder="entree" class="form-control input-md" required="" type="text" value="${the_menu.entree}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input id="email" name="drink" placeholder="Drink" class="form-control input-md" required="" type="text" value="${the_menu.drink}">
